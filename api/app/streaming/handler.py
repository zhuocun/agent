...
async def stream_and_persist(
    *,
    ...
    provider_iter = provider.stream(
        ...
        # Opt this turn into structured output (JSON mode). None (the default)
        # leaves the provider stream byte-for-byte unchanged; the adapters
        # degrade gracefully and the boundary validation below surfaces the
        # result on the attribution.
