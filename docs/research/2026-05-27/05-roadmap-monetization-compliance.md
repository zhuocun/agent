...
- **Several incumbent prices in §5.3 are stale or wrong.** Copilot Pro is **$10/mo** (PRD says ~$20/seat) and Pro+ **$39**; a new **$100/mo ChatGPT Pro tier** (launched Apr 9, 2026) is genuinely unmentioned. (Google's **AI Ultra $100/$200** is *already* in §5.3 as "~$99.99 / ~$200" — so the real gap is labeling the emerging **$100 power-user band**, not a missing Google price.) Perplexity Pro **$20** / Max **$200** confirmed; Mistral Pro **$14.99** / Team **$24.99** confirmed; Poe **$19.99** main tier confirmed (free tier now capped at 300 points, no rollover).
...
| **DeepSeek** | Free app / API | Free (no paywall); ultra-cheap API | Aggressive per-token + cache discounts; **adopted as our cost-leading main provider / default**, with the privacy/geopolitics posture surfaced as a badged tradeoff (PRD 00 D11) | api-docs.deepseek.com |
...
| **EU AI Act Art. 50(2)** (machine-readable marking of AI-generated content) | Mark AI-generated/manipulated content (text/image/audio/video) | **2 Aug 2026 for systems placed on market on/after that date (NO grace); grace to ~2 Dec 2026 only for pre-existing systems** | **Provisional — likely binds 2 Aug 2026 for new launches, pending Official Journal.** Reading: a new launch gets NO grace (grace is pre-existing-systems-only; proposal said →Feb 2 2027, final May agreement ~4mo→2 Dec 2026). For *us* this binds **2 Aug 2026** **if** we generate synthetic media — but the final text is not yet in the Official Journal, so treat as provisional and confirm with counsel. | gibsondunn; mofo (Dec 1 2025); lexology; plesner |
...
6. **[gap] §5.3 — Missing the new $100 ChatGPT "mid-Pro" tier; label the $100 power-user band.** ChatGPT **Pro $100** (Apr 9 2026) is genuinely unmentioned. Google's **AI Ultra $100/$200** is *already* in §5.3 (as "~$99.99 / ~$200"), so it is not absent — it is the same $100-band phenomenon. **Action:** add the ChatGPT Pro $100 row; note the market is segmenting power users into a **$100 band between $20 and $200**.
