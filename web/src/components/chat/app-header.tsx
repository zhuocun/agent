...
const FLOAT_BUTTON =
  "glass-regular size-[46px] rounded-full p-0 text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground aria-expanded:bg-transparent";

const FLOAT_BUTTON_TOUCH =
  "glass-regular size-[46px] rounded-full p-0 text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground aria-expanded:bg-transparent md:hidden";

const PILL_HALF =
  "inline-flex h-[46px] w-[54px] items-center justify-center rounded-full text-muted-foreground transition-colors outline-none hover:text-foreground hover:bg-foreground/5 focus-visible:ring-2 focus-visible:ring-ring";
  ...
  return (
    <header className="relative flex h-[46px] shrink-0 items-center gap-2 pl-[max(env(safe-area-inset-left),1.25rem)] pr-[max(env(safe-area-inset-right),1.25rem)] sm:pl-[max(env(safe-area-inset-left),1.5rem)] sm:pr-[max(env(safe-area-inset-right),1.5rem)] md:h-16">
      ...
      <div className="flex flex-1 items-center justify-end">
        <div className="glass-regular inline-flex h-[46px] items-center rounded-full">
          <button
            type="button"
            aria-label="New chat"
            onClick={onNewChat}
