...
export const MODEL_TIERS: ModelTier[] = [
  {
    ...
    // Auto has no single served model, so no single price — the estimate UI
    // shows "unavailable for Auto" rather than a misleading number.
    listPriceInPerM: 0,
    listPriceOutPerM: 0,
    providerId: "deepseek",
  ...
  },
  {
    ...
    supportsAttachments: false,
    supportsVision: false,
    listPriceInPerM: 0.435,
    listPriceOutPerM: 0.87,
    providerId: "deepseek",
    providerLabel: "DeepSeek",
    providerRouteStatus: "available",
    defaultRouteEligible: true,
